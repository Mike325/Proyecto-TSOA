...
import sistemaDistribuido.sistema.clienteServidor.modoUsuarioBuzones.ProcesoCliente;
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (com.equals("Solicitar")){
				...
				imprimeln("Mensaje a enviar: "+campoMensaje.getText());
                                proc.codigo_operacion = (byte)codigosOperacion.getSelectedIndex();
                                proc.archivo_trabajo = campoMensaje.getText();
				//proc.
