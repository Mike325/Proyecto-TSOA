...
import sistemaDistribuido.sistema.clienteServidor.modoUsuarioNombres.ProcesoCliente;
...
public class ClienteFrame extends ProcesoFrame{
	...
	public ClienteFrame(MicroNucleoFrame frameNucleo){
		super(frameNucleo,"Cliente de Archivos Servidor Nombres");
	...
	class ManejadorSolicitud implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			...
			if (com.equals("Solicitar")){
				...
				//Invoca a procesoCliente
				proc.datos_choice(com);
				proc.info_enviada(campoMensaje.getText());
